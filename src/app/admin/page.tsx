...
const ADMIN_EMAILS = ['coreytucker@example.com'] // ← replace with your actual email
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
              {[
                ...
                { label: 'Club — £99/mo', count: orgs.filter(o => o.plan === 'club').length, color: '#8b5cf6', mrr: `£${orgs.filter(o => o.plan === 'club').length * 99}` },
              ].map(p => (
            ...
            <div style={{ background: CARD, border: `1px solid ${BD}`, borderRadius: 8, padding: '20px 24px' }}>
              ...
              <div style={{ fontSize: 52, fontWeight: 900, color: GOLD }}>
                £{orgs.filter(o => o.plan === 'pro').length * 29 + orgs.filter(o => o.plan === 'club').length * 99}
              </div>
