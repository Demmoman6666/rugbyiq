...
const PLANS = [
  {
    ...
    features: ['1 match per month', '1 analyst seat', 'Manual event coding', 'Basic stats', 'Share links'],
    color: '#64748b',
    cta: 'Start for free',
    highlight: false,
  },
  {
    ...
    price: '£29',
    period: '/mo',
    desc: 'Most popular for active clubs',
    features: ['Unlimited matches', '3 analyst seats', 'AI scanning', 'Review builder', 'Player stats', 'Shareable links'],
    color: '#0ea5e9',
    cta: 'Upgrade to Pro',
    highlight: true,
  },
  {
    ...
    price: '£99',
    period: '/mo',
    desc: 'For serious analysis teams',
    features: ['Unlimited everything', '10 analyst seats', 'Season statistics', 'GPS integration', 'Priority support'],
    color: '#8b5cf6',
    cta: 'Upgrade to Club',
    highlight: false,
  },
