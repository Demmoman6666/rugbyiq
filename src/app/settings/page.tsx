              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                  {[
                    ...
                    { key: 'pro',     name: 'Pro',     price: '£29/mo', features: ['4 matches/month', 'Manual coding', 'Player stats', 'Stats dashboard', 'Share links'], color: GOLD },
                    { key: 'club',    name: 'Club',    price: '£99/mo', features: ['Unlimited matches', 'Up to 20 analyst seats', 'AI scan & AI Review', 'Team sheets', 'Season statistics', 'Priority support'], color: '#8b5cf6' },
                  ].map(plan => {
